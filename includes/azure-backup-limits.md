Olá seguintes limites aplica tooAzure cópia de segurança.
...
| Discos de dados ligados tooan máquina virtual do Azure para cópia de segurança |16 |

* <sup>1</sup>limite de 54400 GB Olá não se aplica a cópia de segurança VM de tooIaaS.
