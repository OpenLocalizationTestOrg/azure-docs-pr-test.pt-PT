...
3. Na caixa de pesquisa de Olá de Olá catálogo Microsoft Update, introduza o número de Base de dados de conhecimento (KB) Olá de correção de Olá que pretende toodownload, por exemplo **3186843**e, em seguida, clique em **pesquisa**.
   
    Olá listagem de correção é apresentado, por exemplo, **cumulativa 3.0 de atualização de pacote de Software para a série de 8000 do StorSimple**.
...
5. Procure as correções adicionais listados na tabela de Olá acima (**3186859**) e adicione cada cesto toohello.
...
1. Após a conclusão da atualização de software Olá, verifique as versões de software do sistema Olá. Escreva:
   ...
   * `MdsAgentVersion: 30.0.4698.16`
     ...
     > 
     > 
2. Repita os passos 3 a 5 controladores de Olá LSI tooinstall e correção de firmware **KB3186859**. Após a correção de Olá estiver instalada, utilize Olá `Get-HcsSystem` cmdlet. versão de Olá LSI deve ser:
   
   * `Lsisas2Version: 2.0.78.00`
3. Repita os passos 3 a 5 tooinstall Olá Storport e atualização Spaceport **KB3121261**.
4. Se estão a atualizar a partir da atualização 2 ou versão anterior, também terá toodownload:
