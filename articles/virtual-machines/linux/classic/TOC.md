...
# Introdução
## [Criar uma VM com Linux com o portal de Olá](createportal.md)
...
### [Monitorizar VMs utilizando Olá diagnóstico extensão da VM](../diagnostic-extension.md)
### [Monitorizar VMs utilizando v2.x de Olá diagnóstico extensão da VM](diagnostic-extension-v2.md)
...
### [Criar um anfitrião de Docker utilizando Olá CLI](cli-use-docker.md)
### [Criar um anfitrião de Docker através do portal Olá](portal-use-docker.md)
### [Como toouse Docker Swarm com o](../../virtual-machines-linux-docker-swarm.md)
...
## Rede
### [Portas abertas tooyour VM](setup-endpoints.md)
...
#### [Utilizar conjuntos com balanceamento de carga tooclusterize MySQL](mysql-cluster.md)
...
### [Aplicações de MPI RDMA cluster toorun](rdma-cluster.md)
### [Como toouse Olá Azure multisservidor Plug-in com Hudson CI](../../virtual-machines-azure-slave-plugin-for-hudson.md)
### HPC Pack
