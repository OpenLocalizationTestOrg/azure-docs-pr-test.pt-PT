---
title: "dados de referência de aaaManage para um ambiente de informações de séries de tempo do Azure através da utilização de c# | Microsoft Docs"
description: "Este tutorial abrange como toomanage referência a dados para um ambiente de informações de séries de tempo do Azure através da utilização de c#"
keywords: 
