...
> [!IMPORTANT]
> Antes de trabalhar com recursos do Azure, é importante toounderstand que o Azure tem atualmente dois modelos de implementação: Azure Resource Manager e clássico. Confirme que compreende os [modelos e ferramentas de implementação](../azure-resource-manager/resource-manager-deployment-model.md) antes de trabalhar com qualquer recurso do Azure. Pode ver a documentação de Olá de diversas ferramentas clicando Olá nos separadores na parte superior de Olá deste artigo. Este artigo abrange o modelo de implementação do Resource Manager Olá. 

[!INCLUDE [virtual-network-create-udr-scenario-include.md](../../includes/virtual-network-create-udr-scenario-include.md)]

## <a name="udr-resources-in-a-template-file"></a>Recursos UDR num ficheiro de modelo
Pode ver e transferir Olá [modelo de exemplo](https://github.com/telmosampaio/azure-templates/tree/master/IaaS-NSG-UDR).

Olá secção seguinte mostra a definição de Olá de Olá UDR front-end no Olá **azuredeploy-vnet-nsg-udr.json** ficheiro para o cenário de Olá:
...
tooassociate Olá UDR toohello front-end sub-rede, tem de definição de sub-rede Olá toochange no modelo de Olá e utilizar id de referência de Olá para Olá UDR.
...
Também precisa de tooensure esse Olá **FW1** VM tem IP Olá propriedade ativada no Olá NIC que será utilizado tooreceive e reencaminhar pacotes de reencaminhamento. secção de Olá abaixo mostra a definição de Olá de hello NIC para FW1 no ficheiro de azuredeploy-nsg-udr.json Olá, com base no cenário de Olá acima.
...
2. Execute Olá toocreate de comando a seguir um grupo de recursos:

    ```powershell
    New-AzureRmResourceGroup -Name TestRG -Location westus
    ```

3. Execute Olá modelo de Olá toodeploy de comando a seguir:
...
modelo ARM do Olá toodeploy utilizando Olá CLI do Azure, Olá concluir os seguintes passos:
...
2. Execute Olá modo do comando tooswitch tooResource Manager os seguintes:
...
3. O seu browser, navegue demasiado**https://raw.githubusercontent.com/telmosampaio/azure-templates/master/IaaS-NSG-UDR/azuredeploy.parameters.json**, copie Olá conteúdo do ficheiro de json Olá e cole um novo ficheiro na sua computador. Para este cenário, deverá copiar os valores de Olá abaixo tooa ficheiro denominado **c:\udr\azuredeploy.parameters.json**.
...
4. Execute os seguintes comandos toodeploy Olá nova VNet com Olá ficheiros de modelo e o parâmetro transferiu e alterou acima de Olá:
...
5. Execute Olá recursos Olá tooview de comandos criados no grupo de recursos novo Olá os seguintes:
...
> [!TIP]
> Se não vir todos os recursos de Olá, execute Olá `azure group deployment show` Olá tooensure de comando de implementação de Olá o estado de aprovisionamento é *Succeded*.
> 
