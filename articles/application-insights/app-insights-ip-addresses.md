...
---
# <a name="ip-addresses-used-by-application-insights"></a>Endereços IP utilizados pelo Application Insights
Olá [Azure Application Insights](app-insights-overview.md) serviço utiliza um número de endereços IP. Poderá ser necessário tooknow estes endereços se Olá aplicação que está a monitorizar estiver alojada atrás de uma firewall.

> [!NOTE]
> Embora estes endereços são estáticos, é possível que precisamos toochange dos mesmos tootime de tempo.
> 
> 

## <a name="outgoing-ports"></a>Portas de envio
É necessário tooopen algumas portas de envio no hello de tooallow de firewall do seu servidor Application Insights SDK e/ou o portal do Monitor de estado toosend dados toohello:
...
Esta é Olá lista de endereços a partir da qual [testes web de disponibilidade](app-insights-monitor-web-app-availability.md) são executados. Se pretende que os testes web toorun na sua aplicação, mas o servidor web tooserving restrito de clientes específico, em seguida, terá de tráfego de entrada toopermit dos nossos servidores de teste de disponibilidade.
