...
Bem-vindo tooMicrosoft Azure StorSimple a implementação do dispositivo. Estes tutoriais de implementação aplicam-se tooStorSimple 8000 atualização 2 da série. Esta série de tutoriais inclui uma lista de verificação das configurações, pré-requisitos de configuração e passos de configuração detalhados para o dispositivo StorSimple.

informações de Olá nestes tutoriais pressupõem que ter revisto as precauções de segurança Olá e descompactado, montou em bastidor e instalou os cabos do dispositivo StorSimple. Se ainda precisar de tooperform das tarefas, comece por ler Olá [precauções de segurança](storsimple-safety.md). Siga Olá instruções específicas do dispositivo toounpack, montar em bastidor e instalar os cabos do dispositivo.
...
| [Pré-requisitos da implementação](#deployment-prerequisites) |Estes validam Olá ambiente está preparado para implementação. |
|  | |
...
| [Passo 2: Obter a chave de registo do serviço de Olá](#step-2-get-the-service-registration-key) |Utilize esta chave tooregister & ligar o dispositivo StorSimple com o serviço de gestão de Olá. |
...
| [Passo 4: Concluir a configuração mínima do dispositivo](#step-4-complete-minimum-device-setup)</br>[Opcional: Atualizar o dispositivo StorSimple](#scan-for-and-apply-updates) |Utilize a configuração de dispositivo do Olá gestão serviço toocomplete Olá e ativá-la tooprovide armazenamento. |
...
| [Passo 7: Montar, inicializar e formatar um volume](#step-7-mount-initialize-and-format-a-volume)</br>[Opcional: Configurar o MPIO](storsimple-configure-mpio-windows-server.md) |Ligar o servidores toohello o armazenamento iSCSI fornecido pelo dispositivo Olá. Opcionalmente, configure tooensure MPIO que os servidores podem tolerar a falha de ligação, rede e interface. |
...
Antes de implementar o seu dispositivo, terá de software do toocollect informações tooconfigure Olá no dispositivo StorSimple. A preparar algumas destas informações antecedência ajudará a simplificar o processo de Olá de implementação de dispositivo do StorSimple Olá no seu ambiente. Transfira e utilize toonote esta lista de verificação pendente detalhes de configuração de Olá à medida que implementa o seu dispositivo.
...
Antes de configurar o dispositivo de Olá, certifique-se de que o dispositivo é completamente descompactado, montado num bastidor e totalmente instalou os cabos de alimentação, rede e acesso de série conforme descrito em:
...
Depois de Olá serviço StorSimple Manager se encontra em execução, terá de chave de registo do serviço de Olá tooget. Esta chave é utilizada tooregister e ligar o dispositivo StorSimple com o serviço de Olá.

Efetue Olá os seguintes passos no Portal de gestão de Olá.
...
Efetue Olá seguindo os passos do programa de configuração do Olá Portal de gestão toocomplete Olá mínima do dispositivo.
...
Efetue Olá os seguintes passos no Portal de gestão de Olá toocreate um contentor de volume.

[!INCLUDE [storsimple-create-volume-container](../../includes/storsimple-create-volume-container.md)]

## <a name="step-6-create-a-volume"></a>Passo 6: Criar um volume
Depois de criar um contentor de volume, pode aprovisionar um volume de armazenamento no dispositivo do StorSimple Olá para os servidores. Execute os seguintes passos no Portal de gestão de Olá toocreate um volume de Olá.
...
Olá, os seguintes passos é efetuado no anfitrião do Windows Server. 
...
Efetue Olá os seguintes passos no Portal de gestão de Olá toocreate uma cópia de segurança agendada.
...
Efetuar Olá os seguintes passos no Olá Portal de gestão, no Olá **serviço StorSimple Manager** página.
...
Efetue Olá os seguintes passos no Olá Portal de gestão toocreate uma pedido cópia de segurança manual de um único volume no dispositivo StorSimple.
