...
* Ver mais toolearn de guias de funcionalidades sobre as opções adicionais para armazenar dados no Azure.
  * [Introdução ao Table storage do Azure através do .NET](storage-dotnet-how-to-use-tables.md) toostore estruturados dados.
  * [Introdução ao Blob storage do Azure através do .NET](storage-dotnet-how-to-use-blobs.md) toostore dados não estruturados.
  * [Ligar tooSQL da base de dados, utilizando o .NET (c#)](../sql-database/sql-database-develop-dotnet-simple.md) toostore de dados relacionais.
