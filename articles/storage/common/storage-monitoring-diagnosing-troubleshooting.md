...
* [orientações de resolução de problemas]
  ...
  * [Resolução de problemas de armazenamento de ficheiros do Azure com o Windows](../files/storage-troubleshoot-windows-file-connection-problems.md)   
  * [Resolução de problemas de armazenamento de ficheiros do Azure com o Linux](../files/storage-troubleshoot-linux-file-connection-problems.md)
* [Appendices]
