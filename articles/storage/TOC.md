...
### [Anexar um disco gerido de tooa VM do Windows com o PowerShell](../virtual-machines/windows/attach-disk-ps.md)
### [Adicionar um disco gerido de tooa VM com Linux](../virtual-machines/linux/add-disk.md)
...
### [Utilizar blobs de tooaccess Olá CDN do Azure com domínios personalizados através de HTTPs](storage-https-custom-domain-cdn.md) 
### [Acesso anónimo tooblobs](storage-manage-access-to-resources.md)
...
### [Migrar VMs do Azure tooAzure geridos discos](../virtual-machines/windows/migrate-to-managed-disks.md)
### [Migrar a partir do AWS e outras plataformas tooManaged discos](../virtual-machines/windows/on-prem-to-azure.md)
...
#### [TooPremium migrar armazenamento utilizando o Azure Site Recovery](storage-migrate-to-premium-storage-using-azure-site-recovery.md)
...
### [Utilizar Olá emulador de armazenamento](storage-use-emulator.md)
...
## Transferir Dados
### [Mover dados tooand de armazenamento](storage-moving-data.md)
### [AzCopy no Windows](storage-use-azcopy.md)
### [AzCopy no Linux](storage-use-azcopy-linux.md)
### [Utilizar o serviço de importação/exportação Olá](storage-import-export-service.md)
### [Utilizar Olá ferramenta para importar/exportar](storage-import-export-tool-how-to.md)
#### [Configurar Olá ferramenta para importar/exportar](storage-import-export-tool-setup.md)
...
#### [Resolução de problemas Olá ferramenta para importar/exportar](storage-import-export-tool-troubleshooting-v1.md)
...
### [Utilizar Olá ferramenta de importação/exportação (v1)](storage-import-export-tool-how-to-v1.md)
#### [Configurar Olá ferramenta para importar/exportar](storage-import-export-tool-setup-v1.md)
...
#### [Formato de ficheiro dos metadados e propriedades do serviço Importar/Exportar](storage-import-export-file-format-metadata-and-properties.md)
#### [Formato de ficheiro do registo do serviço Importar/Exportar](storage-import-export-file-format-log.md)
### [Utilizar a REST API do serviço de importação/exportação do Azure Olá](storage-import-export-using-the-rest-api.md)
