...
* Uma conta de armazenamento do Azure. Se ainda não tiver uma conta de armazenamento, pode criar um utilizando os passos de Olá em [criar uma conta de armazenamento](storage-create-storage-account.md#create-a-storage-account).
...
Para obter mais informações, consulte também Olá [Centro de programadores Java](https://azure.microsoft.com/develop/java/).
