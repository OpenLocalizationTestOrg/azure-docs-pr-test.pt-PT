...
## [Utilizar o PowerShell toomanage Gestor de tráfego](traffic-manager-powershell-arm.md)
## [Aponte o tooTraffic de domínio de Internet Manager](traffic-manager-point-internet-domain.md)
