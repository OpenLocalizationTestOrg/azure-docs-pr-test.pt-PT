...
Neste tutorial, saiba como toointegrate Learningpool funcionar com o Azure Active Directory (Azure AD).

Integrar Learningpool Act com o Azure AD fornece-lhe Olá seguintes vantagens:

- Pode controlar no Azure AD que tenha acesso tooLearningpool Act
- Pode ativar a sua utilizadores tooautomatically get com sessão iniciada tooLearningpool Act (Single Sign-On) com as respetivas contas do Azure AD
...
integração do Azure AD com o ato de Learningpool tooconfigure, terá de Olá seguintes itens:
...
1. A adição de Learningpool ato de galeria Olá
2. Configurar e testar o Azure AD de sessão único-

## <a name="adding-learningpool-act-from-hello-gallery"></a>A adição de Learningpool ato de galeria Olá
tooconfigure Olá integração do Learningpool Act com o Azure AD, é necessário tooadd Learningpool Act Olá Galeria tooyour na lista de aplicações SaaS geridas.

**tooadd Learningpool ATO da Galeria de Olá, execute Olá os seguintes passos:**
...
4. Na caixa de pesquisa de Olá, escreva **Learningpool Act**.
...
5. No painel de resultados de Olá, selecione **Learningpool Act**e, em seguida, clique em **adicionar** botão a aplicação de Olá tooadd.
...
Para único início de sessão toowork, do Azure AD tem tooknow que utilizador homólogo Olá Learningpool Act é tooa utilizador no Azure AD. Por outras palavras, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionados Olá Learningpool Act tem toobe estabelecida.

No Learningpool Act, atribua o valor de Olá da Olá **nome de utilizador** no Azure AD como valor Olá Olá **Username** relação de ligação de Olá tooestablish.

tooconfigure e teste do Azure AD-início de sessão único com o ato de Learningpool, terá de Olá toocomplete blocos modulares os seguintes:
...
3. **[Criar um utilizador de teste Learningpool Act](#creating-a-learningpool-act-test-user)**  -toohave um homólogo de Britta Simon no Learningpool Act que é toohello ligado do Azure AD de representação do utilizador.
...
Nesta secção, pode ativar do Azure AD-início de sessão único em Olá portal do Azure e configurar o início de sessão único na sua aplicação Learningpool Act.

**tooconfigure do Azure AD-início de sessão único com o ato de Learningpool, execute Olá os seguintes passos:**

1. No Olá portal do Azure, no Olá **Learningpool Act** página de integração de aplicações, clique em **de sessão único-**.
...
3. No Olá **Learningpool Act domínio e os URLs** secção, execute Olá os seguintes passos:

    ![Configurar o início de sessão único](./media/active-directory-saas-Learningpool-tutorial/tutorial_Learningpoolact_url.png)

    a. No Olá **URL de início de sessão** caixa de texto, tipo Olá URL:`https://parliament.preview.Learningpool.com/auth/shibboleth/index.php`
    ...
    > [!NOTE] 
    > Estes valores não estiverem reais. Atualizar estes valores com Olá real URL de início de sessão e o identificador. Contacte [equipa de suporte de cliente de Act Learningpool](https://www.Learningpool.com/support) tooget estes valores. 
...
5. Aplicação de Learningpool Act espera asserções de SAML Olá num formato específico. Configure Olá seguintes afirmações para esta aplicação. Pode gerir os valores de Olá destes atributos a partir de Olá **"Atrribute"** separador da aplicação Olá. Olá seguinte captura de ecrã mostra um exemplo para este. 
...
6. No Olá **atributos de utilizador** secção em Olá **de sessão único-** caixa de diálogo, configurar atributos token SAML, conforme mostrado na imagem de Olá e efetuar Olá os seguintes passos:
    ...
    d. Deixe Olá **espaço de nomes** em branco.
...
8. tooconfigure-início de sessão único em **Learningpool Act** lado, terá de Olá toosend transferido **XML de metadados** demasiado[equipa de suporte do Learningpool Act](https://www.Learningpool.com/support). Configuram Olá de toohave esta definição corretamente em ambos os lados de ligação de SAML SSO.
...
tooenable do Azure AD os utilizadores toolog no tooLearningpool Act, estes têm de ser aprovisionados para Learningpool Act.

Não há nenhum item de ação para tooconfigure utilizador tooLearningpool ato de aprovisionamento.  
Os utilizadores precisam de toobe criado pelo seu [equipa de suporte do Learningpool Act](https://www.Learningpool.com/support).

>[!NOTE]
>Pode utilizar quaisquer outras Learningpool Act utilizador conta criação ferramentas ou APIs fornecidas pelo Learningpool Act tooprovision contas de utilizador do AAD. 

### <a name="assigning-hello-azure-ad-test-user"></a>Atribuir o utilizador de teste de Olá do Azure AD

Nesta secção, vai ativar Britta Simon toouse do Azure-início de sessão único, concedendo acesso tooLearningpool Act.

![Atribua o utilizador][200] 

**tooassign Britta Simon tooLearningpool Act, execute Olá os seguintes passos:**

1. No portal do Azure Olá, abra a vista de aplicações de Olá e, em seguida, navegue toohello vista de diretório e aceda demasiado**aplicações empresariais** , em seguida, clique em **todas as aplicações**.

    ![Atribua o utilizador][201] 

2. Na lista de aplicações de Olá, selecione **Learningpool Act**.
...
Ao clicar Olá Learningpool Act na peça de mosaico Olá painel de acesso, deve obter automaticamente com sessão iniciada tooyour aplicação Learningpool Act.
