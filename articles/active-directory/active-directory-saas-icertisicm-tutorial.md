...
Neste tutorial, saiba como toointegrate Icertis plataforma de gestão de contrato com o Azure Active Directory (Azure AD).

Plataforma de gestão de contrato Icertis a integração com o Azure AD fornece-lhe Olá seguintes vantagens:

- Pode controlar no Azure AD que tenha acesso tooIcertis plataforma de gestão do contrato
- Pode ativar a utilizadores tooautomatically get com sessão iniciada tooIcertis plataforma de gestão do contrato (Single Sign-On) com as respetivas contas do Azure AD
...
integração do Azure AD com a plataforma de gestão de contrato Icertis tooconfigure, terá de Olá seguintes itens:
...
1. A adição de plataforma de gestão de contrato Icertis de galeria Olá
2. Configurar e testar o Azure AD de sessão único-

## <a name="adding-icertis-contract-management-platform-from-hello-gallery"></a>A adição de plataforma de gestão de contrato Icertis de galeria Olá
tooconfigure Olá integração da plataforma de gestão do Icertis contrato com o Azure AD, é necessário tooadd plataforma de gestão de contrato Icertis Olá Galeria tooyour na lista de aplicações SaaS geridas.

**tooadd Icertis contrato plataforma de gestão da Galeria de Olá, execute Olá os seguintes passos:**
...
4. Na caixa de pesquisa de Olá, escreva **plataforma de gestão de contrato Icertis**.

    ![Criar um utilizador de teste do Azure AD](./media/active-directory-saas-icertisicm-tutorial/tutorial_icertisicm_search.png)

5. No painel de resultados de Olá, selecione **plataforma de gestão de contrato Icertis**e, em seguida, clique em **adicionar** botão a aplicação de Olá tooadd.
...
Para único início de sessão toowork, do Azure AD tem tooknow qual o utilizador que homólogo Olá na plataforma de gestão de contrato Icertis é tooa utilizador no Azure AD. Por outras palavras, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionados do Olá na plataforma de gestão de contrato Icertis tem toobe estabelecida.

Na plataforma de gestão de contrato Icertis, atribua o valor de Olá da Olá **nome de utilizador** no Azure AD como valor Olá Olá **Username** relação de ligação de Olá tooestablish.

tooconfigure e teste do Azure AD-início de sessão único com a plataforma de gestão de contrato Icertis, terá de Olá toocomplete blocos modulares os seguintes:
...
3. **[Criar um utilizador de teste de plataforma de gestão de contrato Icertis](#creating-an-icertis-contract-management-platform-test-user)**  -toohave um homólogo de Britta Simon na plataforma de gestão de contrato Icertis é toohello ligado do Azure AD de representação do utilizador.
...
Nesta secção, pode ativar do Azure AD-início de sessão único em Olá portal do Azure e configurar o início de sessão único na sua aplicação da plataforma de gestão do Icertis contrato.

**tooconfigure do Azure AD-início de sessão único com a plataforma de gestão de contrato de Icertis efetuar Olá os seguintes passos:**

1. No Olá portal do Azure, no Olá **plataforma de gestão de contrato Icertis** página de integração de aplicações, clique em **de sessão único-**.
...
3. No Olá **URLs e de domínio de plataforma de gestão de contrato Icertis** secção, execute Olá os seguintes passos:

    ![Configurar o início de sessão único](./media/active-directory-saas-icertisicm-tutorial/tutorial_icertisicm_url.png)

    a. No Olá **URL de início de sessão** caixa de texto, escreva um URL Olá seguir o padrão de utilização:`https://<company name>.icertis.com`

    b. No Olá **identificador** caixa de texto, escreva um URL Olá seguir o padrão de utilização:`https://<company name>.icertis.com`

    > [!NOTE] 
    > Estes valores não estiverem reais. Atualizar estes valores com Olá real URL de início de sessão e o identificador. Contacte [equipa de suporte de cliente de plataforma de gestão de contrato Icertis](https://www.icertis.com/company/contact/) tooget estes valores. 
...
Nesta secção, vai criar um utilizador chamado Britta Simon na plataforma de gestão do Icertis contrato. Consulte [equipa de suporte de plataforma de gestão de contrato Icertis](https://www.icertis.com/company/contact/) tooadd utilizadores Olá Olá Icertis plataforma de gestão de contrato.

### <a name="assigning-hello-azure-ad-test-user"></a>Atribuir o utilizador de teste de Olá do Azure AD

Nesta secção, ative Britta Simon toouse do Azure-início de sessão único, concedendo acesso tooIcertis plataforma de gestão de contrato.

![Atribua o utilizador][200] 

**tooassign Britta Simon tooIcertis plataforma de gestão do contrato, execute Olá os seguintes passos:**

1. No portal do Azure Olá, abra a vista de aplicações de Olá e, em seguida, navegue toohello vista de diretório e aceda demasiado**aplicações empresariais** , em seguida, clique em **todas as aplicações**.

    ![Atribua o utilizador][201] 

2. Na lista de aplicações de Olá, selecione **plataforma de gestão de contrato Icertis**.
...
Ao clicar em mosaico de plataforma de gestão de contrato Icertis Olá no painel de acesso de Olá, deve obter automaticamente com sessão iniciada tooyour aplicação Icertis plataforma de gestão de contrato.
