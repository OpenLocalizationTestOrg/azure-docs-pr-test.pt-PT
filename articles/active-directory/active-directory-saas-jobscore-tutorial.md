...
Neste tutorial, saiba como toointegrate JobScore com o Azure Active Directory (Azure AD).

Integrar JobScore com o Azure AD fornece-lhe Olá seguintes vantagens:

- Pode controlar no Azure AD que tenha acesso tooJobScore
- Pode ativar a sua utilizadores tooautomatically get com sessão iniciada tooJobScore (Single Sign-On) com as respetivas contas do Azure AD
...
integração do Azure AD com JobScore tooconfigure, terá de Olá seguintes itens:
...
1. Adicionar JobScore da Galeria de Olá
2. Configurar e testar o Azure AD de sessão único-

## <a name="adding-jobscore-from-hello-gallery"></a>Adicionar JobScore da Galeria de Olá
tooconfigure Olá integração de JobScore com o Azure AD, é necessário tooadd JobScore Olá Galeria tooyour na lista de aplicações SaaS geridas.

**tooadd JobScore da Galeria de Olá, execute Olá os seguintes passos:**
...
4. Na caixa de pesquisa de Olá, escreva **JobScore**.

    ![Criar um utilizador de teste do Azure AD](./media/active-directory-saas-jobscore-tutorial/tutorial_jobscore_search.png)

5. No painel de resultados de Olá, selecione **JobScore**e, em seguida, clique em **adicionar** botão a aplicação de Olá tooadd.
...
Para único início de sessão toowork, do Azure AD tem tooknow que utilizador homólogo Olá JobScore é tooa utilizador no Azure AD. Por outras palavras, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionados Olá JobScore tem toobe estabelecida.

No JobScore, atribua o valor de Olá da Olá **nome de utilizador** no Azure AD como valor Olá Olá **Username** relação de ligação de Olá tooestablish.

tooconfigure e teste do Azure AD-início de sessão único com JobScore, terá de Olá toocomplete blocos modulares os seguintes:
...
3. **[Criar um utilizador de teste JobScore](#creating-a-jobscore-test-user)**  -toohave um homólogo de Britta Simon no JobScore é toohello ligado do Azure AD de representação do utilizador.
...
Nesta secção, pode ativar do Azure AD-início de sessão único em Olá portal do Azure e configurar o início de sessão único na sua aplicação JobScore.

**tooconfigure do Azure AD-início de sessão único com JobScore, execute Olá os seguintes passos:**

1. No Olá portal do Azure, no Olá **JobScore** página de integração de aplicações, clique em **de sessão único-**.
...
3. No Olá **JobScore domínio e os URLs** secção, execute Olá os seguintes passos:

    ![Configurar o início de sessão único](./media/active-directory-saas-jobscore-tutorial/tutorial_jobscore_url.png)

    No Olá **URL de início de sessão** caixa de texto, escreva um URL Olá seguir o padrão de utilização:`https://hire.jobscore.com/auth/adfs/<company name>`

    > [!NOTE] 
    > Este valor não é real. Atualizar este valor com Olá real URL de início de sessão. Contacte [equipa de suporte de cliente JobScore](mailto:support@jobscore.com) tooget este valor. 
...
6. tooconfigure-início de sessão único em **JobScore** lado, terá de Olá toosend transferido **XML de metadados** demasiado[equipa de suporte de JobScore](mailto:support@jobscore.com). 
...
Nesta secção, vai criar um utilizador chamado Britta Simon JobScore. Trabalhar com [equipa de suporte de JobScore](mailto:support@jobscore.com) utilizadores de Olá tooadd na plataforma de JobScore Olá.

### <a name="assigning-hello-azure-ad-test-user"></a>Atribuir o utilizador de teste de Olá do Azure AD

Nesta secção, vai ativar Britta Simon toouse do Azure-início de sessão único, concedendo acesso tooJobScore.

![Atribua o utilizador][200] 

**tooassign Britta Simon tooJobScore, execute Olá os seguintes passos:**

1. No portal do Azure Olá, abra a vista de aplicações de Olá e, em seguida, navegue toohello vista de diretório e aceda demasiado**aplicações empresariais** , em seguida, clique em **todas as aplicações**.

    ![Atribua o utilizador][201] 

2. Na lista de aplicações de Olá, selecione **JobScore**.
...
Ao clicar em mosaico de JobScore Olá no painel de acesso de Olá, deve obter automaticamente com sessão iniciada tooyour JobScore aplicação.
