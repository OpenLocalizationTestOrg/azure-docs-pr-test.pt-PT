...
Neste tutorial, saiba como toointegrate Allocadia com o Azure Active Directory (Azure AD).

Integrar Allocadia com o Azure AD fornece-lhe Olá seguintes vantagens:

- Pode controlar no Azure AD que tenha acesso tooAllocadia
- Pode ativar a sua utilizadores tooautomatically get com sessão iniciada tooAllocadia (Single Sign-On) com as respetivas contas do Azure AD
...
integração do Azure AD com Allocadia tooconfigure, terá de Olá seguintes itens:
...
1. Adicionar Allocadia da Galeria de Olá
2. Configurar e testar o Azure AD de sessão único-

## <a name="adding-allocadia-from-hello-gallery"></a>Adicionar Allocadia da Galeria de Olá
tooconfigure Olá integração de Allocadia com o Azure AD, é necessário tooadd Allocadia Olá Galeria tooyour na lista de aplicações SaaS geridas.

**tooadd Allocadia da Galeria de Olá, execute Olá os seguintes passos:**
...
4. Na caixa de pesquisa de Olá, escreva **Allocadia**.

    ![Criar um utilizador de teste do Azure AD](./media/active-directory-saas-allocadia-tutorial/tutorial_allocadia_search.png)

5. No painel de resultados de Olá, selecione **Allocadia**e, em seguida, clique em **adicionar** botão a aplicação de Olá tooadd.
...
Para único início de sessão toowork, do Azure AD tem tooknow que utilizador homólogo Olá Allocadia é tooa utilizador no Azure AD. Por outras palavras, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionados Olá Allocadia tem toobe estabelecida.

No Allocadia, atribua o valor de Olá da Olá **nome de utilizador** no Azure AD como valor Olá Olá **Username** relação de ligação de Olá tooestablish.

tooconfigure e teste do Azure AD-início de sessão único com Allocadia, terá de Olá toocomplete blocos modulares os seguintes:
...
3. **[Criar um utilizador de teste Allocadia](#creating-an-allocadia-test-user)**  -toohave um homólogo de Britta Simon no Allocadia é toohello ligado do Azure AD de representação do utilizador.
...
Nesta secção, pode ativar do Azure AD-início de sessão único em Olá portal do Azure e configurar o início de sessão único na sua aplicação Allocadia.

**tooconfigure do Azure AD-início de sessão único com Allocadia, execute Olá os seguintes passos:**

1. No Olá portal do Azure, no Olá **Allocadia** página de integração de aplicações, clique em **de sessão único-**.
...
3. No Olá **Allocadia domínio e os URLs** secção, execute Olá os seguintes passos:

    ![Configurar o início de sessão único](./media/active-directory-saas-allocadia-tutorial/tutorial_allocadia_url.png)

    a. No Olá **identificador** caixa de texto, escreva um URL através de Olá seguintes padrões: 
       
     Para o ambiente de teste-`https://na2standby.allocadia.com`
    
     Para o ambiente de produção-`https://na2.allocadia.com`

    b. No Olá **URL de resposta** caixa de texto, escreva um URL através de Olá seguintes padrões: 
    ...
    > [!NOTE] 
    > Estes valores não estiverem reais. Atualize estes valores com o URL de identificador e resposta real no Olá. Contacte [equipa de suporte de Allocadia](mailTo:support@allocadia.com) tooget estes valores.

4. Aplicação de Allocadia espera asserções de SAML Olá num formato específico. Configure Olá seguintes afirmações para esta aplicação. Pode gerir os valores de Olá destes atributos a partir de Olá "**atributos de utilizador**" secção na página de integração de aplicações. Olá seguinte captura de ecrã mostra um exemplo para esta configuração. 
...
8. tooconfigure-início de sessão único em **Allocadia** lado, terá de Olá toosend transferido **XML de metadados** demasiado[equipa de suporte de Allocadia](mailTo:support@allocadia.com). Configuram Olá de toohave esta definição corretamente em ambos os lados de ligação de SAML SSO.
...
Aplicação suporta apenas o aprovisionamento de utilizadores de tempo. Após a autenticação de utilizadores são criados na aplicação Olá automaticamente.

### <a name="assigning-hello-azure-ad-test-user"></a>Atribuir o utilizador de teste de Olá do Azure AD

Nesta secção, vai ativar Britta Simon toouse do Azure-início de sessão único, concedendo acesso tooAllocadia.

![Atribua o utilizador][200] 

**tooassign Britta Simon tooAllocadia, execute Olá os seguintes passos:**

1. No portal do Azure Olá, abra a vista de aplicações de Olá e, em seguida, navegue toohello vista de diretório e aceda demasiado**aplicações empresariais** , em seguida, clique em **todas as aplicações**.

    ![Atribua o utilizador][201] 

2. Na lista de aplicações de Olá, selecione **Allocadia**.
...
Ao clicar em mosaico de Allocadia Olá no painel de acesso de Olá, deve obter automaticamente com sessão iniciada tooyour Allocadia aplicação.
