...
Neste tutorial, saiba como toointegrate CompetencyIQ com o Azure Active Directory (Azure AD).

Integrar CompetencyIQ com o Azure AD fornece-lhe Olá seguintes vantagens:

- Pode controlar no Azure AD que tenha acesso tooCompetencyIQ
- Pode ativar a sua utilizadores tooautomatically get com sessão iniciada tooCompetencyIQ (Single Sign-On) com as respetivas contas do Azure AD
...
integração do Azure AD com CompetencyIQ tooconfigure, terá de Olá seguintes itens:
...
1. Adicionar CompetencyIQ da Galeria de Olá
2. Configurar e testar o Azure AD de sessão único-

## <a name="adding-competencyiq-from-hello-gallery"></a>Adicionar CompetencyIQ da Galeria de Olá
tooconfigure Olá integração de CompetencyIQ com o Azure AD, é necessário tooadd CompetencyIQ Olá Galeria tooyour na lista de aplicações SaaS geridas.

**tooadd CompetencyIQ da Galeria de Olá, execute Olá os seguintes passos:**
...
4. Na caixa de pesquisa de Olá, escreva **CompetencyIQ**.
...
5. No painel de resultados de Olá, selecione **CompetencyIQ**e, em seguida, clique em **adicionar** botão a aplicação de Olá tooadd.
...
Para único início de sessão toowork, do Azure AD tem tooknow que utilizador homólogo Olá CompetencyIQ é tooa utilizador no Azure AD. Por outras palavras, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionados Olá CompetencyIQ tem toobe estabelecida.

No CompetencyIQ, atribua o valor de Olá da Olá **nome de utilizador** no Azure AD como valor Olá Olá **Username** relação de ligação de Olá tooestablish.

tooconfigure e teste do Azure AD-início de sessão único com CompetencyIQ, terá de Olá toocomplete blocos modulares os seguintes:
...
3. **[Criar um utilizador de teste CompetencyIQ](#creating-a-competencyiq-test-user)**  -toohave um homólogo de Britta Simon no CompetencyIQ é toohello ligado do Azure AD de representação do utilizador.
...
Nesta secção, pode ativar do Azure AD-início de sessão único em Olá portal do Azure e configurar o início de sessão único na sua aplicação CompetencyIQ.

**tooconfigure do Azure AD-início de sessão único com CompetencyIQ, execute Olá os seguintes passos:**

1. No Olá portal do Azure, no Olá **CompetencyIQ** página de integração de aplicações, clique em **de sessão único-**.
...
3. No Olá **CompetencyIQ domínio e os URLs** secção, execute Olá os seguintes passos:

    ![Configurar o início de sessão único](./media/active-directory-saas-competencyiq-tutorial/tutorial_competencyiq_url1.png)

    a. No Olá **URL de início de sessão** caixa de texto, escreva um URL Olá seguir o padrão de utilização:`https://<customer>.competencyiq.com/`
    
    b. No Olá **identificador** caixa de texto, tipo Olá URL:`https://www.competencyiq.com/`

    > [!NOTE] 
    > valor de URL Olá início de sessão é não real, por isso, atualização isto com o URL de início de sessão real. Contacte [equipa de suporte de cliente CompetencyIQ](https://www.competencyiq.com/) tooget isto. 
...
6. No Olá **CompetencyIQ configuração** secção, clique em **configurar CompetencyIQ** tooopen **configurar início de sessão** janela. Olá cópia **ID de entidade de SAML**, e **único início de sessão no URL do serviço SAML** de Olá **secção de referência rápida.**
...
tooenable do Azure AD os utilizadores toolog no tooCompetencyIQ, estes têm de ser aprovisionados para CompetencyIQ. Contacte [equipa de suporte de CompetencyIQ](https://www.competencyiq.com/) toocreate utilizadores na aplicação Olá.

### <a name="assigning-hello-azure-ad-test-user"></a>Atribuir o utilizador de teste de Olá do Azure AD

Nesta secção, vai ativar Britta Simon toouse do Azure-início de sessão único, concedendo acesso tooCompetencyIQ.

![Atribua o utilizador][200] 

**tooassign Britta Simon tooCompetencyIQ, execute Olá os seguintes passos:**

1. No portal do Azure Olá, abra a vista de aplicações de Olá e, em seguida, navegue toohello vista de diretório e aceda demasiado**aplicações empresariais** , em seguida, clique em **todas as aplicações**.

    ![Atribua o utilizador][201] 

2. Na lista de aplicações de Olá, selecione **CompetencyIQ**.
...
Ao clicar em mosaico de CompetencyIQ Olá no painel de acesso de Olá, deve obter automaticamente a sessão na aplicação Olá.
