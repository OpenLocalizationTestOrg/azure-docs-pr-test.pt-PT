...
Neste tutorial, saiba como toointegrate Teamphoria com o Azure Active Directory (Azure AD).

Integrar Teamphoria com o Azure AD fornece-lhe Olá seguintes vantagens:

- Pode controlar no Azure AD que tenha acesso tooTeamphoria
- Pode ativar a sua utilizadores tooautomatically get com sessão iniciada tooTeamphoria (Single Sign-On) com as respetivas contas do Azure AD
...
integração do Azure AD com Teamphoria tooconfigure, terá de Olá seguintes itens:
...
1. Adicionar Teamphoria da Galeria de Olá
2. Configurar e testar o Azure AD de sessão único-

## <a name="adding-teamphoria-from-hello-gallery"></a>Adicionar Teamphoria da Galeria de Olá
tooconfigure Olá integração de Teamphoria com o Azure AD, é necessário tooadd Teamphoria Olá Galeria tooyour na lista de aplicações SaaS geridas.

**tooadd Teamphoria da Galeria de Olá, execute Olá os seguintes passos:**
...
4. Na caixa de pesquisa de Olá, escreva **Teamphoria**.

    ![Criar um utilizador de teste do Azure AD](./media/active-directory-saas-teamphoria-tutorial/tutorial_teamphoria_search.png)

5. No painel de resultados de Olá, selecione **Teamphoria**e, em seguida, clique em **adicionar** botão a aplicação de Olá tooadd.
...
Para único início de sessão toowork, do Azure AD tem tooknow que utilizador homólogo Olá Teamphoria é tooa utilizador no Azure AD. Por outras palavras, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionados Olá Teamphoria tem toobe estabelecida.

Esta relação de ligação é estabelecida através da atribuição de valor Olá Olá **nome de utilizador** no Azure AD como valor Olá Olá **Username** no Teamphoria.

tooconfigure e teste do Azure AD-início de sessão único com Teamphoria, terá de Olá toocomplete blocos modulares os seguintes:
...
3. **[Criar um utilizador de teste Teamphoria](#creating-a-teamphoria-test-user)**  -toohave um homólogo de Britta Simon no Teamphoria é-lhe representação toohello ligado do Azure AD.
...
Nesta secção, pode ativar do Azure AD início de sessão no portal de gestão do Azure Olá e configurar o início de sessão único na sua aplicação Teamphoria.

**tooconfigure do Azure AD-início de sessão único com Teamphoria, execute Olá os seguintes passos:**

1. No portal de gestão do Azure de Olá, no Olá **Teamphoria** página de integração de aplicações, clique em **de sessão único-**.
...
3. No Olá **Teamphoria domínio e os URLs** secção, execute Olá os seguintes passos:

    ![Configurar o início de sessão único](./media/active-directory-saas-teamphoria-tutorial/tutorial_teamphoria_url.png)

    a. No Olá **URL de início de sessão** caixa de texto, tipo Olá URL Olá seguir o padrão de utilização:`https://<sub-domain>.teamphoria.com/login`  

    > [!NOTE] 
    > Tenha em atenção que estes não são valores reais Olá. Tiver tooupdate estes valores com Olá real URL de início de sessão. Contacte [equipa de suporte de cliente Teamphoria](https://www.teamphoria.com/) tooget Olá início de sessão no URL. 

4. No Olá **certificado de assinatura de SAML** secção, clique em **certificado (Base64)** e, em seguida, guarde o certificado de Olá no seu computador.
...
6. No Olá **Teamphoria configuração** secção, clique em **configurar Teamphoria** tooopen **configurar início de sessão** janela. Olá cópia **único início de sessão no URL do serviço SAML** de Olá **secção de referência rápida.**

    ![Configurar o início de sessão único](./media/active-directory-saas-teamphoria-tutorial/tutorial_teamphoria_configure.png) 

7. tooconfigure-início de sessão único em **Teamphoria** lado, a aplicação de Teamphoria tooyour início de sessão como administrador.

8. Aceda demasiado**definições de administrador** opção na barra de ferramentas esquerdo Olá e em Olá Olá configurar separador, clique em **ON de início de sessão único** janela de configuração do tooopen Olá SSO.

    ![Configurar o início de sessão único](./media/active-directory-saas-teamphoria-tutorial/admin_sso_configure.png)

9. Clique em **adicionar novo fornecedor de identidade** opção no formulário do Olá canto superior direito tooopen Olá para adicionar as definições de Olá para SSO.

    ![Configurar o início de sessão único](./media/active-directory-saas-teamphoria-tutorial/add_new_identity_provider.png)

10. Introduza os detalhes de Olá nos campos de Olá, conforme descrito abaixo-

    ![Configurar o início de sessão único](./media/active-directory-saas-teamphoria-tutorial/Teamphoria_sso_save.png)

    a. **NOME a apresentar** : introduza o nome a apresentar Olá do plug-in de Olá na página Administração de Olá.

    b. **NOME do botão** : nome de Olá do separador Olá que será apresentado na página de início de sessão de Olá para iniciar sessão através do SSO.

    c. **CERTIFICADO** : Abra Olá certificado transferido anteriormente da Olá portal do Azure no bloco de notas, copiar conteúdo Olá Olá mesmo e cole-o aqui na caixa de Olá.

    d. **PONTO de entrada** : Olá colar **único início de sessão no URL do serviço SAML** copiados anterior Olá de formulário portal do Azure.

    e. Mudar a opção de Olá demasiado**ON** e clique em **guardar**. 
...
Na ordem tooenable do Azure AD os utilizadores toolog para Teamphoria, têm de ser aprovisionados para Teamphoria. No caso de Olá da Teamphoria, o aprovisionamento é uma tarefa manual.

**executar de contas de utilizador, tooprovision Olá os seguintes passos:**

1. Inicie sessão no tooyour Teamphoria site da empresa como administrador.

2. Clique em **ADMIN** definições na barra de ferramentas esquerdo Olá e em Olá **GERIR** separador clique no **utilizadores** página de admin Olá tooopen para os utilizadores.
...
4. Nesta página, execute os seguintes ação. 
    ...
    a. No Olá **endereço de correio ELETRÓNICO** caixa de texto, Olá **endereço de correio eletrónico** de BrittaSimon.

    b. No Olá **nome próprio** caixa de texto, tipo **Britta**.

    c. No Olá **Apelido** caixa de texto, tipo **Simon**.

    d. Clique em **convite 1 utilizador**. Utilizador precisa tooaccept Olá convite tooget criado no sistema de Olá.

### <a name="assigning-hello-azure-ad-test-user"></a>Atribuir o utilizador de teste de Olá do Azure AD

Nesta secção, ative Britta Simon toouse do Azure-início de sessão único, concedendo utras tooTeamphoria de acesso.

![Atribua o utilizador][200] 

**tooassign Britta Simon tooTeamphoria, execute Olá os seguintes passos:**
...
2. Na lista de aplicações de Olá, selecione **Teamphoria**.
