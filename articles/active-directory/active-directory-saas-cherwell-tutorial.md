...
Neste tutorial, saiba como toointegrate Cherwell com o Azure Active Directory (Azure AD).

Integrar Cherwell com o Azure AD fornece-lhe Olá seguintes vantagens:

- Pode controlar no Azure AD que tenha acesso tooCherwell
- Pode ativar a sua utilizadores tooautomatically get com sessão iniciada tooCherwell (Single Sign-On) com as respetivas contas do Azure AD
...
integração do Azure AD com Cherwell tooconfigure, terá de Olá seguintes itens:
...
1. Adicionar Cherwell da Galeria de Olá
2. Configurar e testar o Azure AD de sessão único-

## <a name="adding-cherwell-from-hello-gallery"></a>Adicionar Cherwell da Galeria de Olá
tooconfigure Olá integração de Cherwell com o Azure AD, é necessário tooadd Cherwell Olá Galeria tooyour na lista de aplicações SaaS geridas.

**tooadd Cherwell da Galeria de Olá, execute Olá os seguintes passos:**
...
4. Na caixa de pesquisa de Olá, escreva **Cherwell**.

    ![Criar um utilizador de teste do Azure AD](./media/active-directory-saas-cherwell-tutorial/tutorial_cherwell_search.png)

5. No painel de resultados de Olá, selecione **Cherwell**e, em seguida, clique em **adicionar** botão a aplicação de Olá tooadd.
...
Para único início de sessão toowork, do Azure AD tem tooknow que utilizador homólogo Olá Cherwell é tooa utilizador no Azure AD. Por outras palavras, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionados Olá Cherwell tem toobe estabelecida.

No Cherwell, atribua o valor de Olá da Olá **nome de utilizador** no Azure AD como valor Olá Olá **Username** relação de ligação de Olá tooestablish.

tooconfigure e teste do Azure AD-início de sessão único com Cherwell, terá de Olá toocomplete blocos modulares os seguintes:
...
3. **[Criar um utilizador de teste Cherwell](#creating-a-cherwell-test-user)**  -toohave um homólogo de Britta Simon no Cherwell é toohello ligado do Azure AD de representação do utilizador.
...
Nesta secção, pode ativar do Azure AD-início de sessão único em Olá portal do Azure e configurar o início de sessão único na sua aplicação Cherwell.

**tooconfigure do Azure AD-início de sessão único com Cherwell, execute Olá os seguintes passos:**

1. No Olá portal do Azure, no Olá **Cherwell** página de integração de aplicações, clique em **de sessão único-**.
...
3. No Olá **Cherwell domínio e os URLs** secção, execute Olá os seguintes passos:

    ![Configurar o início de sessão único](./media/active-directory-saas-cherwell-tutorial/tutorial_cherwell_url.png)

    No Olá **URL de início de sessão** caixa de texto, escreva um URL Olá seguir o padrão de utilização:`https://<companyname>.cherwellondemand.com/cherwellclient`

    > [!NOTE] 
    > Este valor não é real. Atualize este valor com Olá real URL Sign-on. Contacte [equipa de suporte de Cherwell](https://csm.cherwell.com/contact) tooget este valor.
...
6. No Olá **Cherwell configuração** secção, clique em **configurar Cherwell** tooopen **configurar início de sessão** janela. Olá cópia **ID de entidade de SAML e o único início de sessão no URL do serviço SAML** de Olá **secção de referência rápida.**

    ![Configurar o início de sessão único](./media/active-directory-saas-cherwell-tutorial/tutorial_cherwell_configure.png) 

7. tooconfigure-início de sessão único em **Cherwell** lado, terá de Olá toosend transferido **certificado (Base64)**, **único início de sessão no URL do serviço SAML**, e  **ID de entidade de SAML** demasiado[equipa de suporte de Cherwell](https://csm.cherwell.com/contact). 

    >[!NOTE]
    >A equipa de suporte Cherwell tem toodo Olá real SSO uma configuração. Irá receber uma notificação quando o SSO foi ativado para a sua subscrição.
    > 
...
tooenable do Azure AD os utilizadores toolog no tooCherwell, estes têm de ser aprovisionados para Cherwell.

No caso de Olá da Cherwell, contas de utilizador Olá necessário toobe criado pelo seu [Cherwell a equipa de suporte](https://csm.cherwell.com/contact).

>[!NOTE]
>Pode utilizar quaisquer outras Cherwell utilizador conta criação ferramentas ou APIs fornecidas pelo Cherwell tooprovision do Azure Active Directory, contas de utilizador.

### <a name="assigning-hello-azure-ad-test-user"></a>Atribuir o utilizador de teste de Olá do Azure AD

Nesta secção, vai ativar Britta Simon toouse do Azure-início de sessão único, concedendo acesso tooCherwell.

![Atribua o utilizador][200] 

**tooassign Britta Simon tooCherwell, execute Olá os seguintes passos:**

1. No portal do Azure Olá, abra a vista de aplicações de Olá e, em seguida, navegue toohello vista de diretório e aceda demasiado**aplicações empresariais** , em seguida, clique em **todas as aplicações**.

    ![Atribua o utilizador][201] 

2. Na lista de aplicações de Olá, selecione **Cherwell**.
...
Se quiser tootest as definições de início de sessão único, abra Olá painel de acesso. Para mais informações sobre Olá painel de acesso, consulte [introdução toohello painel de acesso](active-directory-saas-access-panel-introduction.md).
