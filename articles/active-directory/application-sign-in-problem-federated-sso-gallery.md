...
---
# <a name="problems-signing-in-tooa-gallery-application-configured-for-federated-single-sign-on"></a>Problemas de início de sessão na aplicação de galeria tooa configurada para federado-início de sessão único
...
8.  Aceda demasiado**domínios e URLs** secção. Certifique-se de que o valor na caixa de texto valor Olá para o valor do identificador de Olá apresentado no registo de erros Olá correspondência de identificador de Olá Olá.
...
1.  Capture pedido SAML. Siga o tutorial Olá [como toodebug baseados em SAML único início de sessão tooapplications no Azure AD](https://docs.microsoft.com/azure/active-directory/develop/active-directory-saml-debugging) toolearn como toocapture Olá SAML do pedido.
...
*Aplicação de cliente do erro AADSTS65005:hello pediu acesso tooresource ' 00000002-0000-0000-c000-000000000000'. Este pedido falhou porque o cliente de Olá não especificou este recurso na lista de requiredResourceAccess*.
...
problema de Olá toosolve, adicione o valor do identificador exclusivo Olá na configuração de Olá do Azure AD. tooadd um valor de identificador, siga os passos de Olá abaixo:
...
7.  Depois de o carregamento da aplicação Olá, clique em Olá **de sessão único-** do menu de navegação esquerdo da aplicação Olá

8.  Em Olá **domínio e o URL** secção, verifique no Olá **Mostrar avançadas definições de URL**.

9.  no Olá **identificador** um identificador exclusivo para a aplicação Olá do tipo de caixa de texto.

10. **Guardar** configuração Olá.


**Opção de resolução de 2**

Se a opção 1 acima não resolver o problema, tente remover aplicação Olá do diretório de Olá. Em seguida, adicionar e reconfigurar aplicação Olá, siga os passos de Olá abaixo:
...
8.  Atualizar do Azure AD e adicionar aplicação Olá da galeria do Azure AD Olá. Em seguida, Configure a aplicação Olá

<span id="_Hlk477190176" class="anchor"></span>Após a reconfiguração da aplicação Olá, deve ser capaz de toosign na aplicação toohello.
...
[Como toodebug baseados em SAML único início de sessão tooapplications no Azure AD](https://docs.microsoft.com/azure/active-directory/develop/active-directory-saml-debugging)
