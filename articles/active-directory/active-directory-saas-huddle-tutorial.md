...
Neste tutorial, saiba como toointegrate Huddle com o Azure Active Directory (Azure AD).

Integrar Huddle com o Azure AD fornece-lhe Olá seguintes vantagens:

- Pode controlar no Azure AD que tenha acesso tooHuddle
- Pode ativar a sua utilizadores tooautomatically get com sessão iniciada tooHuddle (Single Sign-On) com as respetivas contas do Azure AD
...
integração de tooconfigure do Azure AD com Huddle, terá de Olá seguintes itens:
...
1. Adicionar Huddle da Galeria de Olá
2. Configurar e testar o Azure AD de sessão único-

## <a name="adding-huddle-from-hello-gallery"></a>Adicionar Huddle da Galeria de Olá
integração de Olá tooconfigure de Huddle com o Azure AD, é necessário tooadd Huddle Olá Galeria tooyour na lista de aplicações SaaS geridas.

**tooadd Huddle da Galeria de Olá, execute Olá os seguintes passos:**
...
4. Na caixa de pesquisa de Olá, escreva **Huddle**.

    ![Criar um utilizador de teste do Azure AD](./media/active-directory-saas-huddle-tutorial/tutorial_huddle_search.png)

5. No painel de resultados de Olá, selecione **Huddle**e, em seguida, clique em **adicionar** botão a aplicação de Olá tooadd.
...
Para único início de sessão toowork, do Azure AD tem tooknow que utilizador homólogo Olá Huddle é tooa utilizador no Azure AD. Por outras palavras, uma relação de ligação entre um utilizador do Azure AD e Olá relacionados com o utilizador no Huddle necessidades toobe estabelecida.

No Huddle, atribua o valor de Olá da Olá **nome de utilizador** no Azure AD como valor Olá Olá **Username** relação de ligação de Olá tooestablish.

tooconfigure e teste do Azure AD-início de sessão único com Huddle, terá de Olá toocomplete blocos modulares os seguintes:
...
3. **[Criar um utilizador de teste Huddle](#creating-a-huddle-test-user)**  -toohave um homólogo de Britta Simon no Huddle é toohello ligado do Azure AD de representação do utilizador.
...
Nesta secção, pode ativar do Azure AD-início de sessão único em Olá portal do Azure e configurar o início de sessão único na sua aplicação Huddle.

**tooconfigure do Azure AD-início de sessão único com Huddle, execute Olá os seguintes passos:**

1. No Olá portal do Azure, no Olá **Huddle** página de integração de aplicações, clique em **de sessão único-**.
...
3. No Olá **Huddle domínios e URLs** secção, execute Olá os seguintes passos:

    ![Configurar o início de sessão único](./media/active-directory-saas-huddle-tutorial/tutorial_huddle_url.png)

    No Olá **URL de início de sessão** caixa de texto, escreva um URL Olá seguir o padrão de utilização:`http://<company name>.huddle.com`

    > [!NOTE] 
    > Este valor não é real. Atualizar este valor com Olá real URL de início de sessão. Contacte [equipa de suporte de cliente Huddle](https://huddle.zendesk.com) tooget este valor. 
...
6. No Olá **Huddle configuração** secção, clique em **configurar Huddle** tooopen **configurar início de sessão** janela. Olá cópia **ID de entidade de SAML e o único início de sessão no URL do serviço SAML** de Olá **secção de referência rápida.** 

    ![Configurar o início de sessão único](./media/active-directory-saas-huddle-tutorial/tutorial_huddle_configure.png) 
    
7. tooconfigure-início de sessão único no lado de Huddle, terá de Olá toosend transferido **certificado**, **único início de sessão no URL do serviço SAML**, e **ID de entidade de SAML** demasiado[Equipa de suporte de cliente huddle](https://huddle.zendesk.com). Configuram Olá de toohave esta definição corretamente em ambos os lados de ligação de SAML SSO.  
   
    >[!NOTE]
    > O início de sessão único tem toobe ativado pela equipa de suporte de Huddle Olá. Receberá uma notificação quando Olá configuração foi concluída. 
    > 
...
tooenable do Azure AD os utilizadores toolog no tooHuddle, estes têm de ser aprovisionados para Huddle. No caso de Olá da Huddle, o aprovisionamento é uma tarefa manual.

**tooconfigure aprovisionamento de utilizadores, execute Olá os seguintes passos:**

1. Inicie sessão no tooyour **Huddle** site da empresa como administrador.
...
4. No Olá **criar um novo convite** secção, execute Olá os seguintes passos:
   
   ![Novo convite](./media/active-directory-saas-huddle-tutorial/IC787839.png "novo convite")
   
   a. No Olá **escolha toojoin de pessoas uma equipa tooinvite** lista, selecione **equipa**.

   b. Olá tipo **endereço de correio eletrónico** de um Azure AD válido de conta pretende tooprovision demasiado**Enter endereço de e-mail para pessoas que gostaria de tooinvite** caixa de texto.

   c. Clique em **convidar**.   
   
    >[!NOTE]
    > Olá conta do Azure AD marcador de posição irá receber uma mensagem de e-mail, incluindo uma conta de Olá ligação tooconfirm para ficar ativa. 
    > 

>[!NOTE]
>Pode utilizar quaisquer outras Huddle utilizador conta criação ferramentas ou APIs fornecidas pelo Huddle tooprovision contas de utilizador do Azure AD. 
> 

### <a name="assigning-hello-azure-ad-test-user"></a>Atribuir o utilizador de teste de Olá do Azure AD

Nesta secção, vai ativar Britta Simon toouse do Azure-início de sessão único, concedendo acesso tooHuddle.

![Atribua o utilizador][200] 

**tooassign Britta Simon tooHuddle, execute Olá os seguintes passos:**

1. No portal do Azure Olá, abra a vista de aplicações de Olá e, em seguida, navegue toohello vista de diretório e aceda demasiado**aplicações empresariais** , em seguida, clique em **todas as aplicações**.

    ![Atribua o utilizador][201] 

2. Na lista de aplicações de Olá, selecione **Huddle**.
...
Ao clicar em mosaico de Huddle Olá no painel de acesso de Olá, pode ser obtido automaticamente página de início de sessão da aplicação Huddle.
