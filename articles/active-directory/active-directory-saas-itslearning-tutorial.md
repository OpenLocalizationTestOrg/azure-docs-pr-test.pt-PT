...
Neste tutorial, saiba como toointegrate itslearning com o Azure Active Directory (Azure AD).

Integrar itslearning com o Azure AD fornece-lhe Olá seguintes vantagens:

- Pode controlar no Azure AD que tenha acesso tooitslearning
- Pode ativar a sua utilizadores tooautomatically get com sessão iniciada tooitslearning (Single Sign-On) com as respetivas contas do Azure AD
...
integração do Azure AD com itslearning tooconfigure, terá de Olá seguintes itens:
...
1. Adicionar itslearning da Galeria de Olá
2. Configurar e testar o Azure AD de sessão único-

## <a name="adding-itslearning-from-hello-gallery"></a>Adicionar itslearning da Galeria de Olá
tooconfigure Olá integração de itslearning com o Azure AD, é necessário tooadd itslearning Olá Galeria tooyour na lista de aplicações SaaS geridas.

**tooadd itslearning da Galeria de Olá, execute Olá os seguintes passos:**
...
4. Na caixa de pesquisa de Olá, escreva **itslearning**.
...
5. No painel de resultados de Olá, selecione **itslearning**e, em seguida, clique em **adicionar** botão a aplicação de Olá tooadd.
...
Para único início de sessão toowork, do Azure AD tem tooknow que utilizador homólogo Olá itslearning é tooa utilizador no Azure AD. Por outras palavras, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionados Olá itslearning tem toobe estabelecida.

No itslearning, atribua o valor de Olá da Olá **nome de utilizador** no Azure AD como valor Olá Olá **Username** relação de ligação de Olá tooestablish.

tooconfigure e teste do Azure AD-início de sessão único com itslearning, terá de Olá toocomplete blocos modulares os seguintes:
...
3. **[Criar um utilizador de teste itslearning](#creating-an-itslearning-test-user)**  -toohave um homólogo de Britta Simon no itslearning é toohello ligado do Azure AD de representação do utilizador.
...
Nesta secção, pode ativar do Azure AD-início de sessão único em Olá portal do Azure e configurar o início de sessão único na sua aplicação itslearning.

**tooconfigure do Azure AD-início de sessão único com itslearning, execute Olá os seguintes passos:**

1. No Olá portal do Azure, no Olá **itslearning** página de integração de aplicações, clique em **de sessão único-**.
...
3. No Olá **itslearning domínios e URLs** secção, execute Olá os seguintes passos:

    ![Configurar o início de sessão único](./media/active-directory-saas-itslearning-tutorial/tutorial_itslearning_url.png)

    a. No Olá **URL de início de sessão** caixa de texto, escreva um URL como:
    | |
    |--| 
    | `https://www.itslearning.com/index.aspx`|
    | `https://us1.itslearning.com/index.aspx`|

    b. No Olá **identificador** caixa de texto, escreva um URL como:`urn:mace:saml2v2.no:services:com.itslearning`
...
6. tooconfigure-início de sessão único em **itslearning** lado, terá de Olá toosend transferido **XML de metadados** demasiado[equipa de suporte de itslearning](mailto:support@itslearning.com). Configuram Olá de toohave esta definição corretamente em ambos os lados de ligação de SAML SSO.
...
Nesta secção, vai criar um utilizador chamado Britta Simon itslearning. Trabalhar com [equipa de suporte de cliente itslearning](mailto:support@itslearning.com) para adicionar utilizadores de Olá na plataforma de itslearning Olá. Os utilizadores tem de ser criados e ativados antes de utilizar o início de sessão único.

### <a name="assigning-hello-azure-ad-test-user"></a>Atribuir o utilizador de teste de Olá do Azure AD

Nesta secção, vai ativar Britta Simon toouse do Azure-início de sessão único, concedendo acesso tooitslearning.

![Atribua o utilizador][200] 

**tooassign Britta Simon tooitslearning, execute Olá os seguintes passos:**

1. No portal do Azure Olá, abra a vista de aplicações de Olá e, em seguida, navegue toohello vista de diretório e aceda demasiado**aplicações empresariais** , em seguida, clique em **todas as aplicações**.

    ![Atribua o utilizador][201] 

2. Na lista de aplicações de Olá, selecione **itslearning**.
...
Ao clicar Olá itslearning mosaico no painel de acesso de Olá, deve obter a página de início de sessão da aplicação itslearning. Clique em **iniciar sessão com o Windows Azure ACS1** para início de sessão com êxito na aplicação Olá.
