...
Neste tutorial, saiba como toointegrate HappyFox com o Azure Active Directory (Azure AD).

Integrar HappyFox com o Azure AD fornece-lhe Olá seguintes vantagens:

- Pode controlar no Azure AD que tenha acesso tooHappyFox
- Pode ativar a sua utilizadores tooautomatically get com sessão iniciada tooHappyFox (Single Sign-On) com as respetivas contas do Azure AD
...
integração do Azure AD com HappyFox tooconfigure, terá de Olá seguintes itens:
...
1. Adicionar HappyFox da Galeria de Olá
2. Configurar e testar o Azure AD de sessão único-

## <a name="adding-happyfox-from-hello-gallery"></a>Adicionar HappyFox da Galeria de Olá
tooconfigure Olá integração de HappyFox com o Azure AD, é necessário tooadd HappyFox Olá Galeria tooyour na lista de aplicações SaaS geridas.

**tooadd HappyFox da Galeria de Olá, execute Olá os seguintes passos:**
...
4. Na caixa de pesquisa de Olá, escreva **HappyFox**.

    ![Criar um utilizador de teste do Azure AD](./media/active-directory-saas-happyfox-tutorial/tutorial_happyfox_search.png)

5. No painel de resultados de Olá, selecione **HappyFox**e, em seguida, clique em **adicionar** botão a aplicação de Olá tooadd.
...
Para único início de sessão toowork, do Azure AD tem tooknow que utilizador homólogo Olá HappyFox é tooa utilizador no Azure AD. Por outras palavras, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionados Olá HappyFox tem toobe estabelecida.

No HappyFox, atribua o valor de Olá da Olá **nome de utilizador** no Azure AD como valor Olá Olá **Username** relação de ligação de Olá tooestablish.

tooconfigure e teste do Azure AD-início de sessão único com HappyFox, terá de Olá toocomplete blocos modulares os seguintes:
...
3. **[Criar um utilizador de teste HappyFox](#creating-a-happyfox-test-user)**  -toohave um homólogo de Britta Simon no HappyFox é toohello ligado do Azure AD de representação do utilizador.
...
Nesta secção, pode ativar do Azure AD-início de sessão único em Olá portal do Azure e configurar o início de sessão único na sua aplicação HappyFox.

**tooconfigure do Azure AD-início de sessão único com HappyFox, execute Olá os seguintes passos:**

1. No Olá portal do Azure, no Olá **HappyFox** página de integração de aplicações, clique em **de sessão único-**.
...
3. No Olá **HappyFox domínio e os URLs** secção, execute Olá os seguintes passos:

    ![Configurar o início de sessão único](./media/active-directory-saas-happyfox-tutorial/tutorial_happyfox_url.png)

    a. No Olá **URL de início de sessão** caixa de texto, escreva um URL Olá seguir o padrão de utilização:`https://<subdomain>.happyfox.com/`

    b. No Olá **identificador** caixa de texto, escreva um URL Olá seguir o padrão de utilização:`https://<subdomain>.happyfox.com/saml/metadata/`

    > [!NOTE] 
    > Estes valores não estiverem reais. Atualizar estes valores com Olá real URL de início de sessão e o identificador. Contacte [equipa de suporte de cliente HappyFox](https://support.happyfox.com/home) tooget estes valores. 
...
6. No Olá **HappyFox configuração** secção, clique em **configurar HappyFox** tooopen **configurar início de sessão** janela. Olá cópia **único início de sessão no URL do serviço SAML** de Olá **secção de referência rápida**.

    ![Configurar o início de sessão único](./media/active-directory-saas-happyfox-tutorial/tutorial_happyfox_configure.png) 

7. Inicie sessão no portal do tooyour HappyFox pessoal e navegue demasiado**gerir**, clique em **integrações** separador.

    ![Configurar o início de sessão único](./media/active-directory-saas-happyfox-tutorial/header.png) 

8. No separador de integrações Olá, clique em **configurar** em **SAML integração** tooopen Olá início de sessão único em definições.

    ![Configurar o início de sessão único](./media/active-directory-saas-happyfox-tutorial/configure.png) 

9. Na secção de configuração de SAML, cole Olá **único início de sessão no URL do serviço SAML** que copiou a partir do portal do Azure para **URL de destino de SSO** caixa de texto.

    ![Configurar o início de sessão único](./media/active-directory-saas-happyfox-tutorial/targeturl.png)

10. Abra o certificado Olá transferido a partir do portal do Azure no bloco de notas e cole o conteúdo **IdP assinatura** secção.
...
Aplicação suporta apenas no tempo de aprovisionamento de utilizador e de utilizadores de autenticação são criados na aplicação Olá automaticamente.
        
### <a name="assigning-hello-azure-ad-test-user"></a>Atribuir o utilizador de teste de Olá do Azure AD

Nesta secção, vai ativar Britta Simon toouse do Azure-início de sessão único, concedendo acesso tooHappyFox.

![Atribua o utilizador][200] 

**tooassign Britta Simon tooHappyFox, execute Olá os seguintes passos:**

1. No portal do Azure Olá, abra a vista de aplicações de Olá e, em seguida, navegue toohello vista de diretório e aceda demasiado**aplicações empresariais** , em seguida, clique em **todas as aplicações**.

    ![Atribua o utilizador][201] 

2. Na lista de aplicações de Olá, selecione **HappyFox**.
...
1. Ao clicar em mosaico de HappyFox Olá no painel de acesso de Olá, deve obter a página de início de sessão da aplicação HappyFox. Deverá ver Olá **'SAML'** botão página de início de sessão Olá.

    ![Plug-in](./media/active-directory-saas-happyfox-tutorial/saml.png) 

2. Clique em Olá **'SAML'** botão toolog no tooHappyFox utilizando a sua conta do Azure AD.
