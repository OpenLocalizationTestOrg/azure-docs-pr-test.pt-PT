...
Neste tutorial, saiba como toointegrate Kantega SSO para FishEye/Crucible com o Azure Active Directory (Azure AD).

Integrar Kantega SSO para FishEye/Crucible com o Azure AD fornece-lhe Olá seguintes vantagens:

- Pode controlar no Azure AD que tenha acesso tooKantega SSO para FishEye/Crucible
- Pode ativar a utilizadores tooautomatically get com sessão iniciada tooKantega SSO para FishEye/Crucible (Single Sign-On) com as respetivas contas do Azure AD
...
integração do Azure AD com o SSO Kantega para FishEye/Crucible tooconfigure, terá de Olá seguintes itens:
...
1. Adicionar Kantega SSO para FishEye/Crucible da Galeria de Olá
2. Configurar e testar o Azure AD de sessão único-

## <a name="adding-kantega-sso-for-fisheyecrucible-from-hello-gallery"></a>Adicionar Kantega SSO para FishEye/Crucible da Galeria de Olá
tooconfigure Olá integração do SSO Kantega para FishEye/Crucible com o Azure AD, terá de tooadd Kantega SSO para FishEye/Crucible Olá Galeria tooyour na lista de aplicações SaaS geridas.

**tooadd Kantega SSO para FishEye/Crucible da Galeria de Olá, execute Olá os seguintes passos:**
...
4. Na caixa de pesquisa de Olá, escreva **Kantega SSO para FishEye/Crucible**.
...
5. No painel de resultados de Olá, selecione **Kantega SSO para FishEye/Crucible**e, em seguida, clique em **adicionar** botão a aplicação de Olá tooadd.
...
Para único início de sessão toowork, do Azure AD tem tooknow que utilizador homólogo Olá Kantega SSO para FishEye/Crucible é tooa utilizador no Azure AD. Por outras palavras, uma relação de ligação entre um utilizador do Azure AD e o utilizador relacionados Olá Kantega SSO para FishEye/Crucible tem toobe estabelecida.

Em Kantega SSO para FishEye/Crucible, atribua o valor de Olá da Olá **nome de utilizador** no Azure AD como valor Olá Olá **Username** relação de ligação de Olá tooestablish.

tooconfigure e teste do Azure AD-início de sessão único com o Kantega SSO para FishEye/Crucible, terá de Olá toocomplete blocos modulares os seguintes:
...
3. **[Criar um SSO Kantega para o utilizador de teste de FishEye/Crucible](#creating-a-kantega-sso-for-fisheyecrucible-test-user)**  -toohave um homólogo de Britta Simon em Kantega SSO para FishEye/Crucible é toohello ligado do Azure AD de representação do utilizador.
...
Nesta secção, pode ativar do Azure AD-início de sessão único em Olá portal do Azure e configurar o início de sessão único na sua SSO Kantega para aplicação FishEye/Crucible.

**tooconfigure do Azure AD-início de sessão único com o SSO Kantega para FishEye/Crucible, execute Olá os seguintes passos:**

1. No Olá portal do Azure, no Olá **Kantega SSO para FishEye/Crucible** página de integração de aplicações, clique em **de sessão único-**.
...
3. No **IDP** iniciada modo, Olá **Kantega SSO para o domínio de FishEye/Crucible e URLs** secção efetuar Olá passo a seguir:
...
4. No **SP** modo iniciado, verifique **Mostrar avançadas definições de URL** e efetuar Olá passo a seguir:
    ...
    > [!NOTE] 
    > Estes valores não estiverem reais. Atualizar estes valores com Olá real identificador, o URL de resposta e o URL de início de sessão. Estes valores são recebidos durante a configuração de Olá do plug-in de FishEye/Crucible que é explicado mais tarde no tutorial Olá.
...
7. Numa janela do browser web diferente, inicie sessão no tooyour FishEye/Crucible no servidor no local como administrador.
...
15. No Olá **SAML** secção. Selecione **Azure Active Directory (Azure AD)** de Olá **Adicionar fornecedor de identidade** pendente.
...
17. No Olá **as propriedades da aplicação** secção, execute os seguintes passos:

    ![Configurar o início de sessão único](./media/active-directory-saas-kantegassoforfisheyecrucible-tutorial/addon6.png)

    a. Olá cópia **URI de ID de aplicação** valor e utilizá-lo como **identificador, o URL de resposta e o URL de início de sessão** no Olá **Kantega SSO para o domínio de FishEye/Crucible e URLs** secção no portal do Azure.

    b. Clique em **Seguinte**.

18. No Olá **importar metadados** secção, execute os seguintes passos:
...
19. No Olá **localização nome e SSO** secção, execute os seguintes passos:
...
20. Verificar o certificado de assinatura de Olá e clique em **seguinte**.    

    ![Configurar o início de sessão único](./media/active-directory-saas-kantegassoforfisheyecrucible-tutorial/addon9.png)

21. No Olá **contas de utilizador FishEye** secção, execute os seguintes passos:

    ![Configurar o início de sessão único](./media/active-directory-saas-kantegassoforfisheyecrucible-tutorial/addon10.png)

    a. Selecione **criar utilizadores no diretório interno do FishEye se for necessário** e introduza o nome adequado Olá do grupo de Olá para os utilizadores (pode ser não vários. de grupos separados por vírgulas).
...
23. No Olá **conhecido domínios para o Azure AD** secção, execute os seguintes passos:   
...
tooenable do Azure AD os utilizadores toolog no tooFishEye/Crucible, estes têm de ser aprovisionados para FishEye/Crucible. Em Kantega SSO para FishEye/Crucible, o aprovisionamento é uma tarefa manual.

**tooprovision uma conta de utilizador, execute Olá os seguintes passos:**

1. Inicie sessão no tooyour Crucible no servidor no local como administrador.

2. Paire o rato sobre o ícone e clique em Olá **utilizadores**.
...
4. No Olá **adicionar novo utilizador** diálogo página, execute Olá os seguintes passos:
    ...
    b. No Olá **nome a apresentar** caixa de texto, nome a apresentar do tipo de utilizador de Olá como Britta Simon.
    
    c. No Olá **endereço de correio eletrónico** caixa de texto, como o endereço de correio eletrónico de Olá de tipo de utilizador Brittasimon@contoso.com.

    d. No Olá **palavra-passe** caixa de texto, palavra-passe Olá de tipo de utilizador.  

    e. No Olá **Confirmar palavra-passe** caixa de texto, reintroduza o Olá palavra-passe do utilizador.

    f. Clique em **Adicionar**.   

### <a name="assigning-hello-azure-ad-test-user"></a>Atribuir o utilizador de teste de Olá do Azure AD

Nesta secção, vai ativar Britta Simon toouse do Azure-início de sessão único, concedendo acesso tooKantega SSO para FishEye/Crucible.

![Atribua o utilizador][200] 

**tooassign Britta Simon tooKantega SSO para FishEye/Crucible, execute Olá os seguintes passos:**

1. No portal do Azure Olá, abra a vista de aplicações de Olá e, em seguida, navegue toohello vista de diretório e aceda demasiado**aplicações empresariais** , em seguida, clique em **todas as aplicações**.

    ![Atribua o utilizador][201] 

2. Na lista de aplicações de Olá, selecione **Kantega SSO para FishEye/Crucible**.
...
Ao clicar Olá Kantega SSO para mosaico FishEye/Crucible no painel de acesso de Olá, deve obter automaticamente com sessão iniciada tooyour Kantega SSO para a aplicação de FishEye/Crucible.
