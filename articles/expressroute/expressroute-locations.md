...
tabelas de Olá neste artigo fornecem informações sobre fornecedores de conectividade ExpressRoute, cobertura geográfica ExpressRoute, cloud services da Microsoft suportados no ExpressRoute e integradores de sistemas ExpressRoute (SIs).

## <a name="partners"></a>Fornecedores de conectividade do ExpressRoute
O ExpressRoute é suportado em todas as regiões e localizações do Azure. Olá mapa a seguir fornece uma lista de regiões do Azure e localizações do ExpressRoute. Localizações do ExpressRoute Consulte toothose onde Microsoft mencionam vários fornecedores de serviços.

![Mapa de localização][0]

Terá acesso tooAzure serviços em todas as regiões numa região geopolítica se ligado tooat, pelo menos, uma localização do ExpressRoute numa região geopolítica Olá.

### <a name="azure-regions-tooexpressroute-locations-within-a-geopolitical-region"></a>Localizações de tooExpressRoute de regiões do Azure numa região geopolítica.
Olá, a tabela seguinte fornece um mapa das regiões do Azure tooExpressRoute localizações numa região geopolítica.
...
tabela de Olá abaixo fornece informações sobre regiões e limites geopolíticos para nuvens nacionais.
...
Conectividade em regiões geopolíticas não é suportada na norma Olá SKU do ExpressRoute. Terá de tooenable Olá ExpressRoute premium suplemento toosupport conectividade global. Ambientes de nuvem toonational de conectividade não é suportada. Pode trabalhar com o seu fornecedor de conectividade, se tal for necessário.

## <a name="locations"></a>Localizações dos fornecedores de conectividade

Olá, a tabela seguinte mostra as localizações por fornecedor de serviços. Se quiser tooview fornecedores disponíveis por localização, consulte [fornecedores por localização de serviço](expressroute-locations-providers.md#locations).
...
toolearn mais, consulte [ExpressRoute na China](http://www.windowsazure.cn/home/features/expressroute/).
...
* Com o seu toosee do fornecedor de conectividade, verifique se estiverem ligado tooany de intercâmbios Olá na tabela de Olá acima. Pode verificar o seguinte Olá liga toogather mais informações sobre serviços oferecidos por fornecedores do exchange. Vários fornecedores de conectividade já estão trocas tooEthernet ligado.
...
* Ter o seu fornecedor de conectividade para expandir a localização de peering de toohello de rede à escolha.
...
* Organize um circuito de ExpressRoute com o exchange Olá como o fornecedor de conectividade tooconnect tooMicrosoft.
  * Siga os passos em [criar um circuito ExpressRoute](expressroute-howto-circuit-classic.md) tooset à conectividade.
...
* Se o seu fornecedor de conectividade não está listada, verifique toosee se estiverem ligado tooany de Olá que expressroute Exchange parceiros listados acima.

## <a name="expressroute-system-integrators"></a>Integradores de sistemas ExpressRoute
Ativar toofit conectividade privada que às suas necessidades podem ser um desafio, com base na escala de Olá da sua rede. Pode trabalhar com qualquer um dos integradores de sistemas de Olá listados no Olá tooassist de tabela a seguir, com tooExpressRoute de integração.
...
| **[Olá grupo Consultancy de TI](http://itconsult.com.au/microsoft-expressroute)** | Austrália |
