---
title: "aaaSQL referência de Data Warehouse Transact-SQL | Microsoft Docs"
description: "Conteúdo de tooreference ligações para tópicos de Transact-SQL Olá utilizada pelo SQL Data Warehouse."
...
* [DO](https://msdn.microsoft.com/library/ms177634.aspx)
...
Para obter mais exemplos TSQL, consulte [descrição geral de referência do SQL Data Warehouse][SQL Data Warehouse reference overview].
