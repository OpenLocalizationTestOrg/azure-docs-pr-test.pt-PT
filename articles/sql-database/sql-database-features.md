...
Partilhe uma base de código comuns com o SQL Server de base de dados SQL do Azure e, ao nível da base de dados de Olá, suporta a maioria das Olá funcionalidades do mesmas. diferenças da funcionalidade principal de Olá entre SQL Database do Azure e SQL Server estão no nível de instância de Olá. 

Continuar tooadd funcionalidades tooAzure base de dados SQL. Para Aconselhamo toovisit o nosso serviço de atualizações de página Web para o Azure e toouse respetivo filtros:

* Toohello filtrado [serviço base de dados do SQL Server](https://azure.microsoft.com/updates/?service=sql-database).
* Filtrados tooGeneral disponibilidade [anúncios (GA)](http://azure.microsoft.com/updates/?service=sql-database&update-type=general-availability) para funcionalidades da base de dados SQL.

## <a name="sql-server-and-sql-database-feature-support"></a>Suporte de funcionalidades do SQL Server e base de dados SQL

Olá tabela seguinte lista Olá funcionalidades principais do SQL Server e fornece informações sobre se cada funcionalidade específica é suportada e uma ligação toomore sobre a funcionalidade de Olá. Para Transact-SQL diferenças tooconsider após a migração de uma solução de base de dados existente, consulte [diferenças Transact-SQL resolver durante a migração tooSQL da base de dados](sql-database-transact-sql-information.md).
...
| [Grupos de Disponibilidade AlwaysOn](https://docs.microsoft.com/sql/database-engine/availability-groups/windows/always-on-availability-groups-sql-server) | Não - consulte [ativação pós-falha de grupos e a georreplicação ativa](sql-database-geo-replication-overview.md) |
...
| [Instruções DDL](https://docs.microsoft.com/sql/t-sql/statements/statements) | Consulte mais - instruções individuais
...
| [Instruções de DML](https://docs.microsoft.com/sql/t-sql/queries/queries) | Consulte mais - instruções individuais |
| [Acionadores DML](https://docs.microsoft.com/sql/relational-databases/triggers/dml-triggers) |
...
| [Eventos expandidos](https://docs.microsoft.com/sql/relational-databases/extended-events/extended-events) | Algumas - ver eventos individuais |
...
| [Envio de registo](https://docs.microsoft.com/sql/database-engine/log-shipping/about-log-shipping-sql-server) | Não - consulte [ativação pós-falha de grupos e a georreplicação ativa](sql-database-geo-replication-overview.md) |
...
| [Operações de índice online](https://docs.microsoft.com/sql/relational-databases/indexes/perform-index-operations-online) | É suportada - tamanho de transação limitado pela camada de serviço |
...
| [Predicados de](https://docs.microsoft.com/sql/t-sql/queries/predicates) | Consulte mais - predicados individuais |
| [Serviços R](https://docs.microsoft.com/sql/advanced-analytics/r-services/sql-server-r-services) | Não |
...
| [Agente do SQL Server](https://docs.microsoft.com/sql/ssms/agent/sql-server-agent) | Consulte nos [as tarefas elásticas](sql-database-elastic-jobs-getting-started.md) |
| [SQL Server Analysis Services (SSAS)](https://docs.microsoft.com/sql/analysis-services/analysis-services) | Não - consulte [Azure Analysis Services](https://azure.microsoft.com/services/analysis-services/) |
...
| [SQL Server Integration Services (SSIS)](https://docs.microsoft.com/sql/integration-services/sql-server-integration-services) | Não - consulte [do Azure Data Factory](https://azure.microsoft.com/services/data-factory/) |
| [SQL Server do PowerShell](https://docs.microsoft.com/sql/relational-databases/scripting/sql-server-powershell) | Sim |
| Gerador de perfis do SQL Server | [Suportado](https://docs.microsoft.com/sql/tools/sql-server-profiler/sql-server-profiler) | Não - consulte [alargadas de eventos](sql-database-xevent-db-diff-from-svr.md) |
...
| [Windows Server Clustering de ativação pós-falha](https://docs.microsoft.com/sql/sql-server/failover-clusters/windows/windows-server-failover-clustering-wsfc-with-sql-server) | Não - consulte [ativação pós-falha de grupos e a georreplicação ativa](sql-database-geo-replication-overview.md) |
| [Índices XML](https://docs.microsoft.com/sql/t-sql/statements/create-xml-index-transact-sql) | Sim |

## <a name="next-steps"></a>Passos seguintes

- Para obter informações sobre Olá serviço SQL Database do Azure, consulte [o que é a base de dados SQL?](sql-database-technical-overview.md)
- Para obter informações sobre o suporte de Transact-SQL e diferenças, consulte [diferenças Transact-SQL resolver durante a migração tooSQL da base de dados](sql-database-transact-sql-information.md).
