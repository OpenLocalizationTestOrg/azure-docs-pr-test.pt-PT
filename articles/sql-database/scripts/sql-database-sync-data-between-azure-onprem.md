---
title: "Sincronização exemplo aaaPowerShell entre a base de dados SQL e SQL Server no local | Microsoft Docs"
description: Azure PowerShell toosync de script de exemplo entre uma base de dados do SQL do Azure e uma base de dados do SQL Server no local
