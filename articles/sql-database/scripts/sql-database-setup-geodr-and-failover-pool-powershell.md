...
---
# <a name="use-powershell-tooconfigure-active-geo-replication-for-a-pooled-azure-sql-database"></a>Utilizar o PowerShell tooconfigure georreplicação ativa para uma base de dados SQL do Azure agrupado

Neste exemplo de script do PowerShell configura a georreplicação ativa para uma base de dados SQL do Azure num conjunto elástico e a ativação pós-falha toohello réplica secundária de Olá SQL database do Azure.
...
| [Conjunto AzureRmSqlDatabaseSecondary](/powershell/module/azurerm.sql/set-azurermsqldatabasesecondary)| Muda um site primário toobe base de dados secundária na ativação pós-falha tooinitiate de ordem.|
