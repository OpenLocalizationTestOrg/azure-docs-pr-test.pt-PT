...
---
# <a name="examples-of-mapping-an-existing-web-service-tooodata-through-csdls"></a>Exemplos de mapeamento existente web tooOData de serviço através de CSDLs
> [!IMPORTANT]
...
Utilize toocreate de dados não processados POST subordinado novo e devolver o respetivo servidor definido URL(location) ou tooupdate parte Olá subordinada no servidor de Olá definido URL.  Onde Olá subordinado é um fluxo, ou seja, não estruturado, por ex. um ficheiro de texto.  Cuidado com POST na não idempotent sem uma localização.
...
Utilize tooremove eliminar um URI especificado.
...
Utilize toocreate de dados não processados POST subordinado novo e devolver o respetivo servidor definido URL(location) ou tooupdate parte Olá subordinada no servidor de Olá definido URL.  Onde Olá subordinado é uma estrutura. Cuidado com POST não é idempotent sem uma localização.
...
Utilizar PUT toocreate subordinado novo ou subordinado de todo Olá tooupdate num servidor definido URL.  Onde Olá subordinado é uma estrutura, PUT é idempotent para as múltiplas ocorrências resultará na Olá mesmo Estado, revertidos x = 5.  PUT deve ser utilizada com Olá conteúdo completas de Olá especificado recursos.
...
Utilize colocar em bruto dados toocreate subordinado novo ou subordinado todo do tooupdate Olá um URL de servidor definido.  Onde Olá subordinado é um fluxo, ou seja, não estruturado, por ex. um ficheiro de texto.  PUT é idempotent para as múltiplas ocorrências resultará na Olá mesmo Estado, revertidos x = 5.  PUT deve ser utilizada com Olá conteúdo completas de Olá especificado recursos.
...
Utilize obter não processados dados tooreturn subordinado que é não estruturado, ou seja, o texto.
...
Utilize a paginação RESTful de implementar através do seus dados com GET.  A paginação de predefinição está definida too100 linha por página de dados.
...
* Se estiver interessado em compreender Olá processo de mapeamento de OData geral e o objetivo, leia este artigo [mapeamento de OData do serviço de dados](marketplace-publishing-data-service-creation-odata-mapping.md) tooreview definições, estruturas e instruções.
